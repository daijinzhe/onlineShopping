	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
		   if(CategoryName.equals("a"))
		   {
			 ...
			 {
				if(entry.getValue().getRetailer().equals("a"))
				 {
			...
			for(Map.Entry<String,Console> entry : SaxParserDataStore.consoles.entrySet())
				{
				 if(entry.getValue().getRetailer().equals("b"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
			...
			else if(CategoryName.equals("c"))
			{
				for(Map.Entry<String,Console> entry : SaxParserDataStore.consoles.entrySet())
				{
				 if(entry.getValue().getRetailer().equals("c"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
		   ...
		   else if(CategoryName.equals("d"))
		   {
			   for(Map.Entry<String,Console> entry : SaxParserDataStore.consoles.entrySet())
			   {
				   if(entry.getValue().getRetailer().equals("d"))
				   {
					   hm.put(entry.getValue().getId(),entry.getValue());
				   }
			   }
		   ...
		   else if(CategoryName.equals("e"))
		   {
			   for(Map.Entry<String,Console> entry : SaxParserDataStore.consoles.entrySet())
			   {
				   if(entry.getValue().getRetailer().equals("e"))
				   {
					   hm.put(entry.getValue().getId(),entry.getValue());
				   }
			   }
		...
		for(Map.Entry<String, Console> entry : hm.entrySet())
		{
			...
			pw.print("<li id='item'><img src='images/watch_folder/"+console.getImage()+"' alt='' /></li>");
